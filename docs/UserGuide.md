...
--------|------------------
**Add** | `create_venue n/VENUE_NAME [max/MAXIMUM_OCCUPANCY]` <br> e.g., `create_venue n/Chua Thian Poh Hall max/40`<br><br> `create_booking`e.g., `create_booking d/2020-12-12 t/2359 n/Chua Thian Poh Hall`
